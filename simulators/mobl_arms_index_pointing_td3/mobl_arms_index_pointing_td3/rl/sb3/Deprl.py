...
from deprl import custom_agents.dep_factory #function that is responsible for creating the agent
...
class Deprl(BaseRlModel):
    def __init__(self, simulator, checkpoint_path=None, wandb_id=None, info_keywords=()):
        ...
        self.model = dep_factory(3, ) #2 = deterministic switching; 3 = stochastic switching
